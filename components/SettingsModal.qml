    ...
    ColumnLayout {
      ...
      ColumnLayout {
        ...
        RowLayout {
          ...
          Rectangle {
            implicitHeight: 20; implicitWidth: refHText.implicitWidth + 8; radius: 3; color: Qt.rgba(1, 1, 1, 0.08)
        ...
        RowLayout {
          ...
          Rectangle {
            implicitHeight: 26
            implicitWidth: cliBadgeRow.implicitWidth + 12
            radius: 4
            ...
            RowLayout {
              ...
              anchors.centerIn: parent
              spacing: 4
              Text { text: settingsRoot.cliHealth.installed ? "✓" : "✕"; color: settingsRoot.cliHealth.installed ? "#4ade80" : "#f87171"; font.pixelSize: 11; font.weight: Font.Bold }
              Text { text: "Engine: " + (settingsRoot.cliHealth.version || (settingsRoot.cliHealth.installed ? "Ready" : "Missing")); color: settingsRoot.foreground; font.pixelSize: 11 }
            }
          }
          ...
          Rectangle {
            implicitHeight: 26
            implicitWidth: krBadgeRow.implicitWidth + 12
            radius: 4
            ...
            RowLayout {
              ...
              anchors.centerIn: parent
              spacing: 4
              Text { text: settingsRoot.cliHealth.keyring_available ? "✓" : "✕"; color: settingsRoot.cliHealth.keyring_available ? "#4ade80" : "#f87171"; font.pixelSize: 11; font.weight: Font.Bold }
              Text { text: "Keyring: " + (settingsRoot.cliHealth.keyring_available ? "Ready" : "Unavailable"); color: settingsRoot.foreground; font.pixelSize: 11 }
            }
          }
          ...
          Rectangle {
            implicitHeight: 26
            implicitWidth: clipBadgeRow.implicitWidth + 12
            radius: 4
            ...
            RowLayout {
              ...
              anchors.centerIn: parent
              spacing: 4
              Text { text: settingsRoot.cliHealth.clipboard_available ? "✓" : "✕"; color: settingsRoot.cliHealth.clipboard_available ? "#4ade80" : "#f87171"; font.pixelSize: 11; font.weight: Font.Bold }
              Text { text: "Clipboard (wl-copy): " + (settingsRoot.cliHealth.clipboard_available ? "Ready" : "Missing"); color: settingsRoot.foreground; font.pixelSize: 11 }
            }
          }
        }
      }
      ...
      RowLayout {
        ...
        Rectangle {
          implicitHeight: 32
          implicitWidth: saveBtnText.implicitWidth + 24
          radius: 5

  ...
  Flickable {
    ...
    Item {
      ...
      ColumnLayout {
        ...
        Rectangle {
          visible: authRoot.isDownloadingCli
          Layout.fillWidth: true
          height: 36
          radius: 5
          color: Qt.rgba(authRoot.accent.r, authRoot.accent.g, authRoot.accent.b, 0.15)
          ...
          RowLayout {
            ...
            Text {
              text: "Downloading omawarden backend engine..."
        ...
        // CLI Missing Banner & Action
        Rectangle {
          visible: !authRoot.isDownloadingCli && authRoot.cliHealth && (authRoot.cliHealth.installed === false)
          Layout.fillWidth: true
          implicitHeight: cliMissCol.implicitHeight + 16
          radius: 5
          ...
          ColumnLayout {
            ...
            RowLayout {
              ...
              Text {
                text: "omawarden engine is not installed"
                color: "#f87171"
                font.pixelSize: 11
            ...
            Rectangle {
              ...
              MouseArea {
                ...
                onClicked: authRoot.downloadCliRequested()
              }
            }
          }
        }
